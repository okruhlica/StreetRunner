...
val A = (for (i <- 0 to 10) yield i).map(i => (new RoutePoint(i,i/6)))
                                                  //> A  : scala.collection.immutable.IndexedSeq[workout.RoutePoint] = Vector((0.0
                                                  //| 000,0.0000), (1.0000,0.0000), (2.0000,0.0000), (3.0000,0.0000), (4.0000,0.00
                                                  //| 00), (5.0000,0.0000), (6.0000,1.0000), (7.0000,1.0000), (8.0000,1.0000), (9.
                                                  //| 0000,1.0000), (10.0000,1.0000))
...
}                                                 //> smartEval: (eval: workout.RoutePoint => Int)(A: Seq[workout.RoutePoint])Arra
                                                  //| y[(workout.RoutePoint, Int)]

def evalFn(r:RoutePoint):Int = {
	print("/"+r)
	return r.lat.toInt
}                                                 //> evalFn: (r: workout.RoutePoint)Int
